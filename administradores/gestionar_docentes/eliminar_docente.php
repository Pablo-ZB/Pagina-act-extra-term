...
if (isset($_GET['id'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $mensaje = "Error al eliminar el docente: " . $conn->error;
        $mensaje_tipo = "error";
    }

    $conn->close();
} else {
    $mensaje = "ID de docente no proporcionado.";
    $mensaje_tipo = "error";
}
?>
...
<head>
    ...
    <title><?php echo ($mensaje_tipo === "success") ? "Éxito al Eliminar Docente" : "Error al Eliminar Docente"; ?></title>
    <style>
        body {
